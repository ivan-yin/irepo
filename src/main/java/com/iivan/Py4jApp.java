...
//		main1();
	 ...
	 */
	public static String convertWithP4j(String toConv, HanyuPinyinToneType toneType) throws BadHanyuPinyinOutputFormatCombination {
...
//		outputFormat.setVCharType(HanyuPinyinVCharType.WITH_U_AND_COLON); //ǜ的输出格式设置  'ü' 输出为 "u:"
		...
		if(StringUtil.isNotEmpty(toConv)){
			for (int i = 0; i < toConv.length(); i++) {
				...
				String [] py = PinyinHelper.toHanyuPinyinStringArray(a, outputFormat );
